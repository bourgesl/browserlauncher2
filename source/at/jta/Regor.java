...
final public class Regor {
    ...
    public byte[] enumValueName(int key, int valueNameIndex, int maxValueNameLength) throws RegistryErrorException {
        try {
            return (byte[]) enumValue.invoke(null, new Object[]{Integer.valueOf(key), Integer.valueOf(valueNameIndex), Integer.valueOf(maxValueNameLength)});
    ...
    public byte[] enumKeys(int key, int subkeyIndex, int maxKeyNameLength) throws RegistryErrorException {
        try {
            return (byte[]) enumKey.invoke(null, new Object[]{Integer.valueOf(key), Integer.valueOf(subkeyIndex), Integer.valueOf(maxKeyNameLength)});
        } catch (InvocationTargetException ex) {
            throw new RegistryErrorException(ex.getMessage());
        } catch (IllegalArgumentException ex) {
            throw new RegistryErrorException(ex.getMessage());
    ...
    public int[] getChildInformation(int key) throws RegistryErrorException {
        try {
            return (int[]) queryInfoKey.invoke(null, new Object[]{Integer.valueOf(key)});
        } catch (InvocationTargetException ex) {
            throw new RegistryErrorException(ex.getMessage());
        } catch (IllegalArgumentException ex) {
            throw new RegistryErrorException(ex.getMessage());
    ...
    public int delValue(int key, String valueName) throws RegistryErrorException {
        try {
            Integer ret = (Integer) delValue.invoke(null, new Object[]{Integer.valueOf(key), getString(valueName)});
            if (ret != null) {
                return ret.intValue();
            } else {
                return -1;
    ...
    public int setValue(int key, String valueName, String value) throws RegistryErrorException {
        try {
            Integer ret = (Integer) setValue.invoke(null, new Object[]{Integer.valueOf(key), getString(valueName), getString(value)});
            if (ret != null) {
                return ret.intValue();
            } else {
                return -1;
    ...
    public byte[] readValue(int key, String valueName) throws RegistryErrorException {
        try {
            byte ret[] = (byte[]) queryValue.invoke(null, new Object[]{Integer.valueOf(key), getString(valueName)});
            return ret;
        } catch (InvocationTargetException ex) {
            throw new RegistryErrorException(ex.getMessage());
        } catch (IllegalArgumentException ex) {
    ...
    public int flushKey(int key) throws RegistryErrorException {
        try {
            Integer ret = (Integer) flushKey.invoke(null, new Object[]{Integer.valueOf(key)});
            if (ret != null) {
                return ret.intValue();
            } else {
                return -1;
    ...
    public int delKey(int key, String subkey) throws RegistryErrorException {
        ...
        try {
            Integer ret = (Integer) delKey.invoke(null, new Object[]{Integer.valueOf(key), getString(subkey)});
            if (ret != null) {
                return ret.intValue();
            } else {
                return -1;
    ...
    public int createKey(int key, String subkey) throws RegistryErrorException {
        try {
            int result[] = (int[]) createKey.invoke(null, new Object[]{Integer.valueOf(key), getString(subkey)});
    ...
    public int closeKey(int key) throws RegistryErrorException {
        try {
            Integer ret = (Integer) closeKey.invoke(null, new Object[]{Integer.valueOf(key)});
            if (ret != null) {
                return ret.intValue();
            } else {
                return -1;
    ...
    public int openKey(int key, String subkey, int security_mask) throws RegistryErrorException {
        try {
            int[] result = (int[]) openKey.invoke(null, new Object[]{Integer.valueOf(key), getString(subkey), Integer.valueOf(security_mask)});
